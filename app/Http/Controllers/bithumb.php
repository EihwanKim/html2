...
class bithumb extends Exchange {
    ...
    public function fetch_custom_user_transactions() {
        $this->load_markets();
        $response = $this->privatePostInfoUserTransactions ();
        return $response['data'];
    }
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array())
    {
        $this->load_markets();
        $market = $this->market ($symbol);
        $response = $this->privatePostInfoOrders (array_merge(array(
            'currency' => $market['id'],
            'after' => $since,
            'count' => $limit,
        ), $params));
...
//            $response['message_kr'] = mb_convert_encoding($response['message'], "MS949","UTF-8");
